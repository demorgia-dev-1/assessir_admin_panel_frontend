...
const Profile = () => {
    ...
    const handleUpdateCompanyPicture = async () => {
        ...
        try {
            ...
            toast.error(error.response.data.message || "Failed to update company picture. Please try again.");
        }
    };
    ...
    return (
        <div className=" flex justify-center p-4 mx-2 h-auto">
            <div className="bg-white shadow-lg rounded-xl p-8 w-full max-w-2xl">
                {editType !== 'company' && <div className="relative flex flex-col items-center mb-6">
                    ...
                    <p className=" flex justify-center items-center font-semibold text-green-700"> <span>{adminDetails.type.toUpperCase()}</span></p>
                </div>}
                        ...
                        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div className="bg-gray-50 px-2 py-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                                <h3 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
                                    <span className="inline-block"> <img src={adminLogo} alt="admin" className="h-6 w-6 mr-3" /></span>
                                    Admin Details
                                    <span className="ml-2">
                                        <button
                                            onClick={() => {
                                ...
                                <div className="space-y-3">
                                    <p className="text-gray-700 break-words">
                                        ...
                                        <span className="text-gray-800 break-words">{adminDetails.name}</span>
                                    </p>
                                    <p className="text-gray-700 break-words">
                                        <strong className="font-medium text-gray-600">Email:</strong>
                                        <span className="text-gray-800 break-words">{adminDetails.email}</span>
                                    </p>
                                    <p className="text-gray-700 break-words">
                                        <strong className="font-medium text-gray-600">Phone:</strong>{" "}
                                        <span className="text-gray-800 break-words">{adminDetails.phone}</span>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-gray-50 px-2 py-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                                <h3 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
                                    <span className="inline-block"> <RiHomeOfficeLine className="h-6 w-6 mr-3 text-blue-700" /></span>
                                    Company Details
                                    <span className="ml-2">
                                        <button
                                            onClick={() => {
                                ...
                                <div className="space-y-3">
                                    <p className="text-gray-700 break-words">
                                        <strong className="font-medium text-gray-600">Company:</strong>{" "}
                                        <span className="text-gray-800 break-words">{adminDetails.company.name}</span>
                                    </p>
                                    <p className="text-gray-700 break-words">
                                        <strong className="font-medium text-gray-600">Company Phone:</strong>{" "}
                                        <span className="text-gray-800 break-words">{adminDetails.company.phone}</span>
                                    </p>
                                    <p className="text-gray-700 break-words">
                                        <strong className="font-medium text-gray-600">Company Address:</strong>{" "}
                                        <span className="text-gray-800 break-words">{adminDetails.company.address}</span>
                                    </p>
                                </div>
                            </div>
                        </div>
