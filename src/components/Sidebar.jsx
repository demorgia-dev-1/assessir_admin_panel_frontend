...
const Sidebar = ({ userType, toggleSidebar }) => {
    ...
    const renderCompanyAdminContent = () => (
        <>
            ...
            >
                ...
                <span className="pl-2 md:pl-4" onClick={toggleSidebar}>Dashboard</span>
            </Link>
            <div
            ...
            {dropdownOpen.admin && (
                <ul className="pl-4 pr-4 pb-4 transition-all duration-300 ease-in-out">
                    <Link to="/manageJobRole">
                        <li className="px-3 py-2 md:px-4 md:py-3 hover:bg-purple-600 cursor-pointer border-l-2 border-white/10 ml-4 transition-all duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105 hover:rounded-lg text-xs md:text-sm" onClick={toggleSidebar}>
                            Manage Job Role
                        </li>
                    </Link>
    ...
    return (
        <div className="flex flex-col justify-between h-[84%] md:h-[96%] w-full md:w-64 bg-gradient-to-r from-slate-900 to-slate-800 border-2 border-white/10 backdrop-blur-[20px] shadow-[0_0_10px_rgba(0,0,0,0.2)] items-center overflow-hidden duration-200 ease-in-out text-white md:my-4 ml-4 rounded-lg overflow-y-scroll custom-scrollbar max-w-auto mt-24">
            <div>
            ...
            <div className="border-t border-gray-500 w-full mb-6">
                ...
                <p className='text-center text-sm text-gray-400'>Powered by Asses-siR 2024</p>
            </div>
