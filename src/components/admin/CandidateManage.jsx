...
const ManageCandidate = () => {
      ...
      dispatch(createCandidate(formData))
        ...
        .catch((error) => {
          const errorMessage =
            ...
            "Failed to add candidate due to an unknown error.";
    ...
    reader.onload = async (e) => {
      ...
      try {
        const response = await axios.post(
          `${BASE_URL}company/candidates/bulk-insert`,
          { candidates },
          {
            headers: {
        ...
        Swal.fire({
          ...
          <div class="custon-error-container">
            ...
            <hr class="custom-error-divider" />
            <div class="custom-error-message capitalize">${`Error uploading candidates: ${ error.response?.data?.message || error.message }`}</div>
          </div>`,
          showCancelButton: true,
          position: "center",
          confirmButtonText: "Ok",
  ...
  const handleUpdate = async (e) => {
    ...
    const resultAction = await dispatch(
      updateCandidate({ _id, updatedCandidate })
    ).unwrap();
    ...
    >
      ...
      {formVisible && (
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="flex flex-col">
              <label htmlFor="enrollmentNo" className="font-semibold ">
                Enrollment Number
              </label>
              <input
                type="text"
            ...
            <div className="flex flex-col">
              <label htmlFor="aadharNumber" className="font-semibold ">
                Aadhar Number
              </label>
              <input
                type="text"
      ...
      {viewData && (
        ...
        >
          <div>
            <p>
              <strong>Candidate ID:</strong> {viewData._id}
            </p>
            <p>
              <strong>Enrollment No:</strong> {viewData.enrollmentNo}
            </p>
            <p>
              <strong>Batch Id:</strong> {viewData.batch}
            </p>
            <p>
            ...
            <p>
              <strong>Aadhar No:</strong> {viewData.adharNo}
            </p>
            <p>
              <strong>Address:</strong> {viewData.address}
            </p>
            <p>
              <strong>Father Name:</strong> {viewData.fatherName}
            </p>
          </div>
        </Dialog>
      )}
        ...
        >
          <form onSubmit={handleUpdate} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="flex flex-col">
                <label htmlFor="contact" className="mb-1 font-semibold text-lg">
                  Phone
                </label>
                <input
                  type="text"
              ...
              <div className="flex flex-col">
                <label htmlFor="adharNo" className="mb-1 font-semibold text-lg">
                  Aadhar Number
                </label>
                <input
                  type="text"
            ...
            <div className="flex space-x-4">
              ...
              <button
                ...
                className="w-32 py-3 text-white bg-red-600 hover:bg-red-700 focus:ring-red-300 shadow-lg shadow-red-500/50 dark:shadow-lg dark:shadow-red-800/80 font-medium rounded-md text-sm px-5 text-center me-2 mb-2 transition-all duration-200 ease-in-out transform hover:-translate-y-1 hover:scale-110"
              >
                Close
              </button>
            </div>
