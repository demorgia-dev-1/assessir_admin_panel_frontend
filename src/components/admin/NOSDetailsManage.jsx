...
const NOSDetailsManage = () => {
  ...
  const { sectors, jobRoles, selectedSector, selectedJobRole, noses } =
    useSelector((state) => state.nos);
    ...
    reader.onload = async (e) => {
      ...
      const transformedData = jsonData
        .map((row, index) => {
          ...
          validNOSType =
            validNOSType === "non core nos" ? "non-core-nos" : "core-nos";
          const validTotalMarks = TotalMarks !== undefined ? TotalMarks : 0;
          const validTheoryMarks = TheoryMarks !== undefined ? TheoryMarks : 0;
          const validPracticalMarks =
            PracticalMarks !== undefined ? PracticalMarks : 0;
          ...
          if (
            ...
            !validNOSCode ||
            !validNOSType ||
            validTotalMarks === undefined
          ) {
            validationErrors.push(
              `Row ${index + 1}: Missing or invalid values.`
            );
            return null;
          }
      ...
      try {
        const response = await axios.post(
          `${BASE_URL}company/nos/bulk-insert`,
          { nos: transformedData },
          {
            headers: {
  ...
  const filteredNoses = selectedJobRole
    ? noses.filter((nos) => nos.jobRole?._id === selectedJobRole._id)
    : [];
    ...
    >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
            <div className="flex flex-col flex-1">
              <label htmlFor="nosname" className="font-semibold">
                NOS Name
              </label>
              <input
                type="text"
            ...
            <div className="flex flex-col flex-1">
              <label htmlFor="noscode" className="font-semibold">
                NOS Code
              </label>
              <input
                type="text"
            ...
            <div className="flex flex-col flex-1">
              <label htmlFor="nostype" className="font-semibold">
                NOS Type
              </label>
              <select
                id="nostype"
            ...
            <div className="flex flex-col flex-1">
              <label htmlFor="totalmarkstheory" className="font-semibold">
            ...
            <div className="flex flex-col flex-1">
              <label htmlFor="totalmarkspractical" className="font-semibold">
            ...
            <div className="flex flex-col flex-1">
              <label htmlFor="totalmarksviva" className="font-semibold">
                Total Marks in Viva
              </label>
              <input
                type="number"
          ...
          {!selectedSector && (
            <div className="text-red-500 text-md mt-2">
              Please select a Sector && Job Role before entering NOS
              information.
            </div>
          )}
      ...
      {viewData && (
        ...
        >
          <div>
            <p>
              <strong>NOS ID:</strong> {viewData._id}
            </p>
            <p>
              <strong>NOS Name:</strong> {viewData.nosName}
            </p>
            <p>
              <strong>NOS Code:</strong> {viewData.nosCode}
            </p>
            <p>
        ...
        <div className=" p-1 max-w-[100%] sm:w-[100%] lg:w[100%] md:w-[100%]  ">
          ...
          >
            ...
            <Column
              field="nosName"
              header="NOS Name"
              className="py-2 sm:px-4 border-b"
            />
            <Column
              field="nosCode"
              header="NOS Code"
