...
const ManageAssessor = () => {
  ...
  const sectorOptions = Array.isArray(sectors)
    ? sectors.map((sector) => ({
        value: sector,
  ...
  const jobRoleOptions = Array.isArray(jobRoles)
  ...
  return (
    <div
      className="max-w-[20rem]  xs:max-w-[23rem] my-2  md:max-w-[86rem] sm:max-w-[50rem] lg:max-w-[100%] xl:w-[100%]
    ...
    >
        ...
        <div className="grid grid-cols-1 p-2  md:grid-cols-3 gap-4 bg-gray-100 rounded-lg py-2 pb-6">
          <div className="flex flex-col">
            ...
            <MultiSelect
              ...
              value={selectedSectors?.map((sectorId) =>
                sectors.find((sector) => sector._id === sectorId)
              )}
          ...
          <div className="flex flex-col">
            <label
              ...
              className="mb-1 font-semibold text-md ml-1"
            >
              Select Job Roles<span className=" text-red-500"> * </span>
            </label>
            <MultiSelect
              id="jobRoles"
              value={selectedJobRoles?.map((jobRoleId) =>
                jobRoles.find((jobRole) => jobRole._id === jobRoleId)
              )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="flex flex-col">
              <label
                ...
                className="mb-1 font-semibold text-md  ml-1"
              >
                Assessor Phone<span className=" text-red-500"> * </span>
              </label>
              <input
                type="tel"
                id="contact"
            ...
            <div className="flex flex-col">
              <label
                ...
                className="mb-1 font-semibold text-md  ml-1"
              >
                Assessor Address<span className=" text-red-500"> * </span>
              </label>
              <input
                type="text"
                id="address"
            ...
            <div className="flex flex-col relative">
              <label
                ...
                className="mb-1 font-semibold text-md ml-1"
              >
                Assessor Password<span className=" text-red-500"> * </span>
              </label>
              <input
            ...
            <div className="flex flex-col">
              <label
                ...
                className="mb-1 font-semibold text-md ml-1"
              >
                SIP User Id<span className=" text-red-500"> * </span>
              </label>
              <input
                type="text"
                id="sipuserid"
      ...
      {selectedAssessor && (
        ...
        >
          <div>
            <p>
              <strong>Assessor ID:</strong> {selectedAssessor._id}
            </p>
            <p>
              <strong>Assessor Name:</strong> {selectedAssessor.name}
            </p>
            <p>
              <strong>Email:</strong> {selectedAssessor.email}
            </p>
            <p>
              <strong>Contact:</strong> {selectedAssessor.phone}
            </p>
            <p>
              <strong>Address:</strong> {selectedAssessor.address}
            </p>
            <p>
              <strong>Sectors:</strong>{" "}
              {selectedAssessor.sectors.map((sector) => sector.name).join(", ")}
            </p>
            <p>
              <strong>Job Roles:</strong>{" "}
              {selectedAssessor.jobRoles
                .map((jobRole) => jobRole.name)
                .join(", ")}
            </p>
            <p>
              <strong>SIP User ID:</strong> {selectedAssessor.sipUserId}
            </p>
            <p>
              <strong>SIP Password:</strong> {selectedAssessor.sipPassword}
            </p>
          </div>
        </Dialog>
      )}
        ...
        <form onSubmit={handleUpdate} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                onChange={(e) =>
                  setEditFormData({
                    ...editFormData,
                    assessorContact: e.target.value,
                  })
                }
                name="phone"
                className="px-3 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 transition bg-transparent border-2"
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                onChange={(e) =>
                  setEditFormData({
                    ...editFormData,
                    assessorAddress: e.target.value,
                  })
                }
                name="address"
                className="px-3 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 transition bg-transparent border-2"
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                onChange={(e) =>
                  setEditFormData({
                    ...editFormData,
                    assessorPassword: e.target.value,
                  })
                }
                name="password"
                className="px-3 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 transition bg-transparent border-2"
            ...
            <div className="flex flex-col">
              ...
              <MultiSelect
                id="sectors"
                value={sectors.filter((sector) =>
                  editFormData.selectedSectors.includes(sector._id)
                )}
                options={sectorOptions}
            ...
            <div className="flex flex-col">
              ...
              <MultiSelect
                id="jobRoles"
                value={jobRoles.filter((jobRole) =>
                  editFormData.selectedJobRoles.includes(jobRole._id)
                )}
                options={jobRoleOptions}
          ...
          <div className="flex space-x-4 mt-4">
            ...
            <button
              ...
              className="w-28 py-2 text-white bg-red-600 hover:bg-red-700 focus:ring-red-300 shadow-lg shadow-red-500/50 dark:shadow-lg dark:shadow-red-800/80 font-medium rounded-md text-sm px-5 text-center me-2 mb-2 transition-all duration-200 ease-in-out transform hover:-translate-y-1 hover:scale-110"
            >
              Close
            </button>
          </div>
      ...
      <div className="mt-8 overflow-x-auto sm:w-full md:w-[100%] xl:w-full">
        ...
        <div className="max-w-[23rem] p-1 md:max-w-[50rem] sm:max-w-[30rem] lg:max-w-[76rem]">
          ...
          >
            ...
            />
            <Column
              body={sectorsBodyTemplate}
              header="Sectors "
              className="py-2 px-4 border-b"
            />
            <Column
              body={jobRolesBodyTemplate}
              header="Job Roles"
              className="py-2 px-4 border-b"
            />
            <Column
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mt-4 p-4 gap-4">
        <span className="font-medium text-lg">
          Total Records: {assessors.length}
        </span>
        <div>
