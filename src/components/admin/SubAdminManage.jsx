    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 px-2 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="mb-4">
            <label htmlFor="email" className="mb-1 font-semibold text-md ml-1">
              Email
            </label>
            <input
              type="email"
          ...
          <div className="mb-4">
            <label htmlFor="phone" className="mb-1 font-semibold text-md ml-1">
              Phone
            </label>
            <input
              type="text"
      ...
      {selectedSubAdmin && (
        ...
        >
          <div>
            <p>
              <strong> ID:</strong> {selectedSubAdmin._id}
            </p>
            <p>
              <strong> Name:</strong> {selectedSubAdmin.name}
            </p>
            <p>
              <strong>Email:</strong> {selectedSubAdmin.email}
            </p>
            <p>
              <strong>Contact:</strong> {selectedSubAdmin.phone}
            </p>
            <p>
              <strong>Address:</strong> {selectedSubAdmin.address}
            </p>
            <p>
              <strong>Sectors:</strong>{" "}
              {selectedSubAdmin.sectors.map((sector) => sector.name).join(", ")}
            </p>
          </div>
        </Dialog>
      )}
      ...
      <div className=" overflow-x-auto sm:w-full md:w-[100%] xl:w-full mt-4">
        ...
        <div className="max-w-[100%] p-1  sm:max-w-full  md:max-w-full lg:max-w-[100%]">
          ...
          >
            ...
            />
            <Column
              body={assignedSectorsTemplate}
              header="Assigned Sectors"
              className="py-2 px-4 border-b"
            />
          </DataTable>
        </div>
