...
const ManageBatch = () => {
  ...
  const [isAssessorEvidenceRequired, setIsAssessorEvidenceRequired] =
    useState(true);
  const { sectors, jobRoles, selectedSector, selectedJobRole, batches } =
    ...
    reader.onload = async (e) => {
      ...
      const transformedData = jsonData.map((row) => {
        ...
        return {
          ...
          startDate: startDate
            ? convertToISTWithoutChangingTimeBulk(startDate)
            : "",
          endDate: endDate ? convertToISTWithoutChangingTimeBulk(endDate) : "",
          sector: selectedSector?._id || "",
          jobRole: selectedJobRole?._id || "",
          isPracticalVisibleToCandidate:
            isPracticalVisibleToCandidate?.toLowerCase() === "yes"
              ? true
              : isPracticalVisibleToCandidate?.toLowerCase() === "no"
              ? false
              : undefined,
          isAssessorEvidenceRequired:
            isAssessorEvidenceRequired?.toLowerCase() === "yes"
              ? true
              : isAssessorEvidenceRequired?.toLowerCase() === "no"
              ? false
              : undefined,
        };
      });
      ...
      const missingFields = transformedData
        .map((batch, index) => {
          const fields = [];
          ...
          if (!batch.startDate)
            fields.push("Start Date-Time(mm/dd/yyyy hh:mm)");
          if (!batch.endDate) fields.push("End Date-Time(mm/dd/yyyy hh:mm)");
          if (batch.isPracticalVisibleToCandidate === undefined)
            fields.push("Practical Visible To Candidate");
          if (batch.isAssessorEvidenceRequired === undefined)
            fields.push("Assessor Evidence Required");
      ...
      const hasDuplicateBatchNumbers =
        new Set(batchNumbers).size !== batchNumbers.length;

      if (missingFields.length > 0) {
        const missingFieldsMessage = missingFields
          .map(
            (batch) => `Batch ${batch.index + 1}: ${batch.fields.join(", ")}`
          )
          .join("\n");
      ...
      try {
        const response = await axios.post(
          `${BASE_URL}company/batches/bulk-insert`,
  ...
  const convertToISTWithoutChangingTimeBulk = (inputDateTime) => {
    ...
    if (typeof inputDateTime === "number") {
      ...
      if (!match) {
        throw new Error(
          "Invalid inputDateTime format. Expected format: MM/DD/YYYY HH:MM:SS AM/PM"
        );
      }
      ...
      dateTimeStr = `${year}-${month.padStart(2, "0")}-${day.padStart(
        2,
        "0"
      )}T${hours24.toString().padStart(2, "0")}:${minutes.padStart(
        2,
        "0"
    ...
    if (dateTimeParts.length !== 2) {
      throw new Error(
        "Invalid inputDateTime format. Expected format: YYYY-MM-DDTHH:MM:SS"
      );
    }
  ...
  const filteredBatches = batches.filter((batch) => {
    const matchesJobRole = selectedJobRole
      ? batch.jobRole?._id === selectedJobRole._id
      : [];
    const matchesStatus =
      selectedStatus === "All" ? true : batch.status === selectedStatus;
    ...
    >
      ...
      <div className="flex flex-col  space-y-2">
        <div className="grid grid-cols-1 p-2  md:grid-cols-3 gap-4 bg-gray-100 rounded-lg py-2">
          <div className="flex flex-col">
            <label htmlFor="sector" className="mb-1 font-semibold text-md ml-1">
              Select Sector
            </label>
            <Select
              id="sector"
              ...
              getOptionLabel={(option) =>
                `${option.name.toUpperCase()}(${option.sector_short_name.toUpperCase()})`
              }
          ...
          <div className="flex flex-col">
            <label
              htmlFor="jobrole"
              className="mb-1 font-semibold text-md ml-1"
            >
              Select Job Role
            </label>
            <Select
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="flex flex-col flex-1">
                <label htmlFor="batchName" className="font-semibold">
                  Batch Name
                </label>
                <input
                  type="text"
              ...
              <div className="flex flex-col flex-1">
                <label htmlFor="batchNo" className="font-semibold">
                  Batch No
                </label>
                <input
                  type="text"
              ...
              <div className="flex flex-col">
                <label htmlFor="batchtype" className=" font-semibold">
                  Batch Type
                </label>
                <select
                  id="batchtype"
              ...
              <div className="flex flex-col flex-1">
                <label htmlFor="scheme" className="font-semibold ">
                  Scheme Name
                </label>
                <input
                  type="text"
              ...
              <div className="flex flex-col flex-1">
                <label htmlFor="subscheme" className=" font-semibold">
                  Sub-Scheme
                </label>
                <input
                  type="text"
              ...
              <div className="flex flex-col flex-1">
                <label htmlFor="assessmentStartDate" className="font-semibold">
              ...
              <div className="flex flex-col flex-1">
                <label htmlFor="assessmentEndDate" className="font-semibold ">
              ...
              <div className="flex flex-col flex-1">
                <label htmlFor="assessmentDuration" className="font-semibold">
              ...
              <div className="flex flex-col flex-1">
                <label htmlFor="numberOfCandidates" className="font-semibold">
              ...
              <div className="flex flex-col flex-1 mb-5 mt-2">
                <label className="flex items-center relative w-max cursor-pointer select-none">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setIsAssessorEvidenceRequired(e.target.checked)
                    }
                  />

                  <div
                    className={`w-14 h-7 rounded-md relative transition-colors ${
                      isAssessorEvidenceRequired ? "bg-green-500" : "bg-red-500"
                    }`}
                  >
                    <div
                      className={`w-7 h-7 rounded-md bg-gray-200 absolute top-0 transform transition-transform ${
                        isAssessorEvidenceRequired ? "translate-x-7" : ""
                      }`}
                    />
                  </div>
              ...
              <div className="flex flex-col flex-1 mb-5 mt-2">
                <label className="flex items-center relative w-max cursor-pointer select-none">
                  ...
                  <div
                    className={`w-14 h-7 rounded-md relative transition-colors ${
                      isPracticalVisible ? "bg-green-500" : "bg-red-500"
                    }`}
                  >
                    <div
                      className={`w-7 h-7 rounded-md bg-gray-200 absolute top-0 transform transition-transform ${
                        isPracticalVisible ? "translate-x-7" : ""
                      }`}
                    />
                  </div>
            ...
            {!selectedSector && (
              <div className="text-red-500 text-md mt-2">
                Please select a Sector, Job Role before entering batch
                information.
              </div>
            )}
          ...
          >
            ...
            >
              <p>
                <strong>
                  <i
                    ...
                    style={{ marginRight: "8px", color: "#007ad9" }}
                  ></i>
                  Batch Number:
                </strong>{" "}
                {viewData.no}
              ...
              <p>
                ...
                {convertToIST(viewData.startDate)}
              </p>
              <p>
                <strong>
                  <i
              ...
              <p>
                ...
                {viewData.sector.name.toUpperCase()}
              </p>
              <p>
                <strong>
                  <i
              ...
              <p>
                ...
                {`${viewData.assessor?.name}-${viewData.assessor?.sipUserId}`}
              </p>
              <p>
                <strong>
                  <i
                ...
                {viewData.theoryQuestionBank
                  ? viewData.theoryQuestionBank.name
                  : "N/A"}
              </p>
              <p>
                <strong>
                ...
                {viewData.practicalQuestionBank
                  ? viewData.practicalQuestionBank.name
                  : "N/A"}
              </p>
              <p>
                <strong>
                ...
                {viewData.vivaQuestionBank
                  ? viewData.vivaQuestionBank.name
                  : "N/A"}
              </p>
              <p>
                <strong>
                  <i
                    ...
                    style={{ marginRight: "8px", color: "#007ad9" }}
                  ></i>
                  Practical Visible to Candidate:
                </strong>{" "}
                {viewData.isPracticalVisibleToCandidate ? "Yes" : "No"}
              </p>
              <p>
                <strong>
                  <i
                    ...
                    style={{ marginRight: "8px", color: "#007ad9" }}
                  ></i>
                  Candidate Aadhar Required:
                </strong>{" "}
                {viewData.isCandidateAdharRequired ? "Yes" : "No"}
              </p>
              <p>
                <strong>
                  <i
                ...
                {viewData.isCandidateLocationRequired ? "Yes" : "No"}
              </p>
              <p>
                <strong>
                  <i
                    ...
                    style={{ marginRight: "8px", color: "#007ad9" }}
                  ></i>
                  Candidate Selfie Required:
                </strong>{" "}
                {viewData.isCandidateSelfieRequired ? "Yes" : "No"}
              </p>
              <p>
                <strong>
                  <i
                ...
                {viewData.isCandidatePhotosRequired ? "Yes" : "No"}
              </p>
              <p>
                <strong>
                  <i
                    ...
                    style={{ marginRight: "8px", color: "#007ad9" }}
                  ></i>
                  Random Video Required:
                </strong>{" "}
                {viewData.isCandidateVideoRequired ? "Yes" : "No"}
              </p>
              <p>
                <strong>
                  <i
                ...
                {viewData.isSuspiciousActivityDetectionRequired ? "Yes" : "No"}
              </p>
              <p>
                <strong>
                  <i
                ...
                {viewData.isAssessorEvidenceRequired ? "Yes" : "No"}
              </p>
            </div>
          </div>
        </Dialog>
      ...
      >
        <form onSubmit={handleEditFormSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="flex flex-col">
              <label htmlFor="name" className="mb-1 font-semibold text-md ml-1">
                Batch Name
              </label>
              <input
                type="text"
            ...
            <div className="flex flex-col">
              <label htmlFor="type" className="mb-1 font-semibold text-md ml-1">
                Batch Type
              </label>
              <select
                id="type"
            ...
            <div className="flex flex-col">
              <label htmlFor="no" className="mb-1 font-semibold text-md ml-1">
                Batch Number
              </label>
              <input
                type="text"
              ...
              <label className="flex items-center relative w-max cursor-pointer select-none">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditFormData((prevState) => ({
                      ...prevState,
                      isAssessorEvidenceRequired: e.target.checked,
                    }))
                  }
                />
                <div
                  className={`w-14 h-7 rounded-md relative transition-colors ${
                    editFormData.isAssessorEvidenceRequired
                      ? "bg-green-500"
                      : "bg-red-500"
                  }`}
                >
              ...
              <label className="flex items-center relative w-max cursor-pointer select-none">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditFormData((prevState) => ({
                      ...prevState,
                      isPracticalVisibleToCandidate: e.target.checked,
                    }))
                  }
                />
                <div
                  className={`w-14 h-7 rounded-md relative transition-colors ${
                    editFormData.isPracticalVisibleToCandidate
                      ? "bg-green-500"
                      : "bg-red-500"
                  }`}
                >
          ...
          <div className="flex space-x-4 mt-4">
            <button
              type="submit"
              className="w-28 py-2 text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br font-medium rounded-md text-sm px-5 text-center me-2 mb-2 "
            >
              Update
            </button>
            ...
            <button
              ...
              className="w-28 py-2 text-white bg-red-600 hover:bg-red-700  font-medium rounded-md text-sm px-5 text-center me-2 mb-2 "
            >
              Close
            </button>
          </div>
      ...
      <Dialog
        header="Extend End Date"
        visible={isExtendEndDateVisible}
        style={{ width: "50vw" }}
        onHide={() => setExtendEndDateVisible(false)}
        dismissableMask
      >
        <form onSubmit={handleExtendEndDateSubmit} className="space-y-4">
          ...
          <div className="flex space-x-4 mt-4">
            <button
              type="submit"
              className="w-30 py-2 text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br font-medium rounded-md text-sm px-5 text-center me-2 mb-2 "
            >
              Extend
            </button>
            ...
            <button
              type="button"
              onClick={() => setExtendEndDateVisible(false)}
              className="w-30 py-2 text-white bg-red-600 hover:bg-red-700  font-medium rounded-md text-sm px-5 text-center me-2 mb-2 "
            >
              Close
            </button>
          </div>
        ...
        <div className="flex flex-col  sm:flex-col justify-between items-start  mb-4 gap-4 px-2">
          ...
          <div className="">
            ...
            <select
              ...
              className="py-1 pr-6 border rounded-md"
            >
