...
function ManageBatchAnalytics() {
  ...
  const generateBatchAnalyticsLink = async () => {
    try {
      ...
      const response = await axios.post(
        `${BASE_URL}company/batch-analytics/generate-link`,
        {
  ...
  return (
    <div>
      <h1 className="text-xl font-bold text-gray-800 m-4 mt-14 sm:mt-5">
        Batch Analytics
      </h1>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-gray-50 rounded-lg shadow-md relative overflow-visible">
        <div className="flex-1 min-w-[200px]">
          <label htmlFor="sector" className="block mb-1 font-semibold text-md">
            Select Sector
          </label>
          <Select
            id="sector"
        ...
        <div className="flex-1 min-w-[200px]">
          <label htmlFor="jobrole" className="block mb-1 font-semibold text-md">
            Select Job Role
          </label>
          <Select
            id="jobrole"
        ...
        <div className="flex-1 min-w-[200px]">
          <label htmlFor="batch" className="block mb-1 font-semibold text-md">
            Select Batch
          </label>
          <MultiSelect
            id="batch"
        ...
        <div className="flex-1 min-w-[200px]">
          <label htmlFor="title" className="block mb-1 font-semibold text-md">
            Title
          </label>
          <input
            type="text"
        ...
        <div className=" min-w-[200px] flex items-end">
          <button
            ...
            onClick={generateBatchAnalyticsLink}
          >
            Generate Link
          </button>
        </div>
        ...
        <div className="mt-4">
          <label htmlFor="resData" className="block mb-1 font-semibold text-md">
            Select Batch Analytics
          </label>
          <Select
            id="resData"
            value={null}
