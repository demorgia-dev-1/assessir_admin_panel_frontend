...
const ManageTp = () => {
    ...
    return (
        ...
        mx-auto mt-14 sm:mt-5 p-0 sm:p-2  py-8 bg-white border-2 border-white/10 backdrop-blur-[20px] items-center overflow-hidden duration-200 ease-in-out text-black rounded-lg shadow-lg flex-grow-0 ">
            <h2 className="text-xl font-bold mb-4 ml-1  p-2 text-center sm:text-left">Manage TP</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 my-5">
                <div className="grid grid-cols-1 md:grid-cols-3 p-2 gap-4 rounded-lg py-2 pb-6">
                    <div className="flex flex-col">
                        <label htmlFor="tpId" className="font-semibold">Training Partner Id</label>
                        <input
                            type="text"
                            id="tpId"
                            value={tpId}
                    ...
                    <div className="flex flex-col">
                        <label htmlFor="tpName" className="font-semibold">Training Partner Name</label>
                        <input
                            type="text"
                            id="tpName"
                            value={tpName}
                    ...
                    <div className="flex flex-col">
                        <label htmlFor="tpcontact" className="font-semibold">Training Partner Contact</label>
                        <input
                            type="text"
                            id="tpcontact"
                            value={tpContact}
                    ...
                    <div className="flex flex-col">
                        <label htmlFor="tpemail" className="font-semibold">Training Partner Email</label>
                        <input
                            type="email"
                            id="tpemail"
                            value={tpEmail}
                    ...
                    <div className="flex flex-col">
                        <label htmlFor="tpaddress" className="font-semibold">Training Partner Address</label>
                        <input
                            type="text"
                            id="tpaddress"
                            value={tpAddress}
            ...
            <Dialog header="Edit Training Partner" visible={isEditFormVisible} style={{ width: '50vw' }} onHide={() => setIsEditFormVisible(false)}>
                <form onSubmit={handleEditFormSubmit} className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">

                        <div className="flex flex-col flex-1">
                            <label htmlFor="name" className="mb-1 font-semibold text-sm md:text-lg">Training Partner Name</label>
                            <input
                                type="text"
                                id="name"
                                name="name"
                        ...
                        <div className="flex flex-col flex-1">
                            ...
                            <label htmlFor="phone" className="mb-1 font-semibold text-sm md:text-lg">Training Partner Phone</label>
                            <input
                                type="text"
                                id="phone"
                                name="phone"
                        ...
                        <div className="flex flex-col flex-1">
                            <label htmlFor="email" className="mb-1 font-semibold text-sm md:text-lg">Training Partner Email</label>
                            <input
                                type="email"
                                id="email"
                                name="email"
                        ...
                        <div className="flex flex-col flex-1">
                            <label htmlFor="address" className="mb-1 font-semibold text-sm md:text-lg">Training Partner Address</label>
                            <input
                                type="text"
                                id="address"
                                name="address"
            ...
            <div className="mt-8 overflow-x-auto sm:w-full md:w-[100%] xl:w-full">
                ...
                <div className=" p-1 md:max-w-full lg:max-w-[100%] max-w-[20rem]  xs:max-w-[23rem] sm:max-w-[50rem]">
                    <DataTable value={tps}
                        ...
                        <Column field="tpId" header="TP Id" className="py-2 px-4 border-b " />

                        <Column field="name" header="TP Name" className="py-2 px-4 border-b" />
                        <Column field="email" header="TP Email" className="py-2 px-4 border-b" />
                        <Column field="phone" header="TP Phone" className="py-2 px-4 border-b" />
                        <Column field="address" header="TP Address" className="py-2 px-4 border-b" />
